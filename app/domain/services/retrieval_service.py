...
def retrieve_parent_context(
    ...
    print(f"[MMR 去冗余后子片段数] {len(mmr_child_docs)}")
    ...
    print(f"[最终父片段数] {len(parent_docs)}")
    return parent_docs
